...
export const departmentConfig = {
  guadeloupe: {
    ...
    constructionsFile: () => FileAttachment('../data/guadeloupe_constructions.json'),
    destructionsFile: () => FileAttachment('../data/guadeloupe_destructions.json'),
  ...
  guyane: {
    ...
    constructionsFile: () => FileAttachment('../data/guyane_constructions.json'),
    destructionsFile: () => FileAttachment('../data/guyane_destructions.json'),
  ...
  reunion: {
    ...
    constructionsFile: () => FileAttachment('../data/reunion_constructions.json'),
    destructionsFile: () => FileAttachment('../data/reunion_destructions.json'),
  ...
  martinique: {
    ...
    levelFile: () => FileAttachment('../data/martinique_clusters_level.json'),
    evolFile: () => FileAttachment('../data/martinique_clusters_evol.json'),
  ...
  mayotte: {
    ...
    constructionsFile: () => FileAttachment('../data/mayotte_constructions.json'),
    destructionsFile: () => FileAttachment('../data/mayotte_destructions.json'),
  ...
  "saint-martin": {
    ...
    constructionsFile: () => FileAttachment('../data/saint-martin_constructions.json'),
    destructionsFile: () => FileAttachment('../data/saint-martin_destructions.json'),
